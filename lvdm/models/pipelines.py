        ...
        with torch.set_grad_enabled(True):
            while (
                ...
                if hasattr(model, "alphas_cumprod"):
                    ...
                    alpha_prod_t = model.alphas_cumprod[t]
...
def generate_semantic_guidance(
    ...
    if return_box_vis:
        pil_images = [
            util.draw_box(Image.fromarray(image), bboxes, phrases) for image in images
        ]
