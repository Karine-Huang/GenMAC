...
class LatentDiffusion(DDPM):
    ...
    def apply_model(self, x_noisy, t, cond, cross_attention_kwargs=None, **kwargs):
        ...
        x_recon = self.model(x_noisy, t, **cond, cross_attention_kwargs = cross_attention_kwargs, **kwargs)
