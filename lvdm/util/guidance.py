...
def add_ca_loss_per_attn_map_to_loss(
    ...
    **kwargs,
    ...
    if isinstance(fg_weight, float):
        fg_weight = [fg_weight] * object_number
    ...
    H_attn, W_attn = util.get_hw_from_attn_dim(attn_dim=i, base_attn_dim=base_attn_dim)
    ...
    for obj_idx in range(object_number):
        ...
        for frame_ind, frame_boxes in enumerate(obj_boxes):
            ...
            for obj_box in frame_boxes:
                x_min, y_min, x_max, y_max = util.scale_proportion(obj_box, H=H, W=W)
            ...
            for obj_position in object_positions[obj_idx]:
                ...
                if use_ratio_based_loss:
                    ...
                    if use_max_based_loss:
                        ...
                        obj_loss += fg_loss * fg_weight[obj_idx]
                        bg_loss = (
